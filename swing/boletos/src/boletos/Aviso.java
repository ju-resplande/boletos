...
public class Aviso {
    ...
    boolean VerificaComboBox(){
        ...
        if (janela.jComboBox3.getSelectedItem() == "Selecione"){
            EsqueceuSelecao("o tipo de Documento");
            seSelecionado = false;
        }
        
        if (janela.jComboBox4.getSelectedItem() == "Selecione"){
            EsqueceuSelecao("o Banco");
            seSelecionado = false;
        }
        
        if (janela.jComboBox5.getSelectedItem() == "Selecione"){
            EsqueceuSelecao("se utilizará Aceite");
            seSelecionado = false;
        }
    ...
    public static void avisoExcecao(ParseException excecao, JComponent campo){
        campo.setToolTipText(excecao.getMessage());
        campo.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(242, 34, 34), 2, true));
    }
